 ...
 * -------------------------------------------------------------------------
 *
 * Overrides the _display() method, used to send the finalized page to the web
 * browser at the end of system execution. This permits you to use your own
 * display methodology. Note that you will need to reference the CI superobject
 * with $this->CI =& get_instance() and then the finalized data will be
 ...
 * -------------------------------------------------------------------------
 *
 * Enables you to call your own method instead of the _display_cache() method in
 * the Output Library. This permits you to use your own cache display mechanism.
 */
 ...
 * -------------------------------------------------------------------------
 *
 * Called after the final rendered page is sent to the browser, at the end of
 * system execution after the finalized data is sent to the browser.
 */
