...
$config['sess_cookie_name'] = 'angeli_';
...
|
*/
$config['time_reference'] = env('CI_TIME', 'local');
...
| 'language_path' = Path of JSON files
| 'language_query' = $_GET query paramters for language switcher
*/

$config['language']	= env('BASE_LANGUAGE', 'english');
$config['language_path'] = env('LANGUAGE_PATH', FCPATH.'assets/language');
$config['language_query'] = env('LANGUAGE_QUERY', 'lang');
